...
> Прим.: Композиция (суперпозиция функции) — это применение одной функции к результату другой.
...
Множество $K$ векторов из линейного пространства $L$ называется линейным подпространством пространства $L$ , если сумма $x + y$ любых двух векторов $x$ и $y$ из $L$ принадлежит $K$ и произведение $\alpha \cdot x$ любого любого числа $ \alpha $ и любого вектора $x$ и $y$ из $L$ принадлежит $K$:
...
Прямая сумма — сумма таких подпространств, для которых пересечение состоит только из нулевого вектора.
...
где $X'$ — матрица оператора в новом базисе, $X$ — матрица оператора в старом базисе, $T$ — матрица перехода.
...
След матрицы — это произведение элементов на ее диагонали.
