...
Берем матрицу комплексно сопряженных и транспонируем.
...
Для любого самосопряженного оператора $A$ существует ортонормированный базис из его собственных векторов.
