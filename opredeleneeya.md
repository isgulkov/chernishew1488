...
Всякий многочлен степени $n \ge 1$ на полем $\mathbb{C}$ раскладывается в произведение вида
...
Отношение эквиватентности — это рефлексивное, симметрическое, транзитивное отношение:
